        ...
        Animated.timing(animation.translateX, {
          toValue:
            animation.translateX._value <= 0
              ? 1
              : animation.translateX._value >= DIFF_WIDTH - 5
              ? DIFF_WIDTH - 1
        ...
        Animated.timing(animation.translateY, {
          toValue:
            animation.translateY._value <= 0
              ? 1
              : animation.translateY._value >= DIFF_HEIGHT - ALIEN_SIZE
              ? DIFF_HEIGHT - 1
          ...
          <View key={index}>
            ...
            >
              <View style={styles.alien}>
                <TouchableOpacity
                  onPress={() => handleImageClick(Family[alienKey])}
                >
                  <Text style={styles.nickname}>
                    {Family[alienKey].nickname}
                  </Text>
                  <Image
                    style={styles.image}
